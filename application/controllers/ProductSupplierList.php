...
class ProductSupplierList extends CI_Controller {
	...
	private function getTaxPostData(){
		...
		$invoice_type = $this->getInput('invoice_type');
	...
	public function getInvoiceType(){
		$data = "";
		$result = $this->Productsupplier->getInvoiceTypeList($data);
	...
	public function editIndex(){
		...
		$invoice_type_list = $this->getInvoiceType();
		$cond['invoice_type_list'] = $invoice_type_list["data"]["invoice_type_list"];
		$cond['upload_path'] = $this->upload->upload_path;
