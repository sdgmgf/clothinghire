...
class Productmodel extends CI_Model {
  ...
  */
  ...
  //履约收入的修改
  public function upsertProductRevenue($params){
      return $this->helper->post('/product/revenue/upsert',$params);
  }
  ...
  public function getFulfillRevenueList($product_id) {
  	return $this->helper->get("/product/revenue/get", array('product_id'=>$product_id));
  }
