...
class Order extends CI_Model {
 ...
 public function printOrder($order_id, $tracking_number = null){
  ...
  public function getOrderNoteInFacilityRegion($facility_id) {
  	$out = $this->helper->get("/orders/not_in_facility_region/".$facility_id);
  	if($this->helper->isRestOk($out,'order_list')){
     	return $out['order_list'];
    }
  	return $out;
  }
}
