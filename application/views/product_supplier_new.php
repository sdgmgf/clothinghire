...
<div style="margin-left:10%" id='basicData'>
		<label class="label_info" style="text-align:left;">基础信息</label>   
	        <div class='row'>
				<label  style="text-align: right;"><em style="font-style: normal;color: red;font-weight: 900;">*</em>供应商：</label><input type="text" id="edit_product_supplier_name" name="product_supplier_name" >
			</div>
			<div class='row'>
				<label  style="text-align: right;"><em style="font-style: normal;color: red;font-weight: 900;">*</em>商品类型：</label><select id="edit_product_type" style="width:175px;height:26px" name="product_type" >
			...
			<div class='row'>
				<label  style="text-align: right;"><em style="font-style: normal;color: red;font-weight: 900;">*</em>供应商类型：</label><select id="edit_supplier_type" style="width:175px;height:26px" name="supplier_type" >
					<option value="">==请选择==</option>
			...
			<div class='row'>
				<label  style="text-align: right; margin:0px;vertical-align:top">地址：</label><textarea rows="2" cols="50" id="edit_product_supplier_address" name="product_supplier_address"></textarea>
			</div>
			<div class='row'>
				<label  style="text-align: right;">联系人：</label><input type="text" id="edit_supplier_contact_name" name="supplier_contact_name">
			</div>
			<div class='row'>
				<label  style="text-align: right;">联系电话：</label><input type="text" id="edit_supplier_contact_mobile" name="supplier_contact_mobile" >
			</div>
			<div class='row'>
		...
		<label class="label_info" style="text-align:left;">财务信息</label> 
			<div class='row'>
				<label  style="text-align: right;">开户银行：</label><input placeholder="请填写全称" type="text" id="edit_opening_bank" name="opening_bank">
			</div>
			<div class='row'>
				<label  style="text-align: right;">银行账户：</label><input type="text" id="edit_bank_account" name="bank_account">
			</div>
			<div class='row'>
				<label  style="text-align: right;">账户姓名：</label><input type="text" id="edit_bank_account_name" name="bank_account_name">
			</div>
			<div class='row'>
				<label  style="text-align: right;">付款周期：</label><input type="text" id="edit_payment_cycle" name="payment_cycle">
			</div>
		<label class="label_info" style="text-align:left;">状态信息</label>
			
			
			<div class='row'>
				<label  style="text-align: right;">等级：</label><select id="edit_supplier_level" style="width:175px;height:26px" name="supplier_level" >
					<option value="">==请选择==</option>
			...
			<div class='row'>
				<label style="text-align: right;vertical-align:top">备注：</label><textarea rows="2" cols="50" id="edit_note" name="note"></textarea>
			</div>
