		...
		<div class="row col-md-12" >
				...
				<div class="col-md-10 bs-product-supplies" style="margin-top: 60px" id="product_supplies_div">
					<div class="col-md-12" style="margin-top: 20px;display: inline-block;" >
						<div class="row">  
							<h5 style="display: inline-block;"><span class="required">* </span>采购周期： <input type="number"  class="form-control" id="purchasing_cycle_supplies_raw" name="purchasing_cycle_supplies_raw" style="width: 50%;display: inline-block;" min="1">天</h5> 
						</div>
						<div class="row">
				...
				<div class="col-md-10 bs-product-raw_material" style="margin-top: 60px" id="product_raw_material_div">
					<div class="col-md-6" style="margin-top: 20px" id="product_raw_material_div2">
						...
						<label style="display:inline-block; margin-top: 20px; text-align: left;"></span>采购周期：<input type="number" class="form-control" id="purchasing_cycle_goods_raw" name="purchasing_cycle_goods_raw" style="display: inline;width: 60%;">天</label>
