...
<body>  
    <div class="container-fluid" style="margin-left: -18px;padding-left: 19px;" >
            <div class="col-md-12">
                ...
                <!-- Tab panes -->
                        <form style="width:100%;" method="post"   action="<?php if(isset($WEB_ROOT))  echo $WEB_ROOT ; ?>waybillList">
                                ...
                                <tbody >
                                    <tr>
                                        <td class="product_cell">
                                            <?php echo $data_item['waybill_sn'] ?>
                                        </td>
                                        <td class="product_cell">
                                             <?php echo $data_item['shipping_name'] ?>  
                                        </td>
                                         <td class="product_cell">
                                             <?php echo $data_item['shipment_number'] ?>  
                                        </td>
                                        <td class="product_cell">
                                             <?php echo $data_item['user_name'] ?>  
                                        </td>
                                        <td class="product_cell">
                                             <?php echo $data_item['created_time'] ?>
                                        </td>
                                    </tr>
