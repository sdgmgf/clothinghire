			...
			<div class="row">
	      	...
	      	<table id="price_detail_table"  style="width:880px; border: 3" class="table table-striped table-bordered ">
				<tr>
					...
					<th id="price_detail_total_price_title" style="width: 80px">总价</th>
			...
			<div class="row">
	      	...
	      	<table id="price_keyin_table" style="width: 950px;border: 3" class="table table-striped table-bordered ">
				<tr>
					...
					<th id="price_keyin_total_price_title" style="width: 80px">总价</th>
					<th id="price_keyin_other_price_title" style="width: 80px">其他费用</th>
					<th id="price_keyin_unit_price_title" style="width: 80px">单价</th>
					...
					<th id="price_keyin_operator_title" style="width: 30px"></th>
				</tr>
			</table>
			<br>
