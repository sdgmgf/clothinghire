...
<ul class="nav nav-tabs">
    ...
    <?php if($this->helper->chechActionList( array('getFulfillRevenue'))) {?>
		<li id="revenue_li" style=""><a href="#revenue_div" data-toggle="tab">履约收入</a></li>
	<?php }?>
		...
		<div class="row col-md-12" >
			...
			<div class="col-md-10 bs-product-supplies" style="margin-top: 60px" id="product_supplies_div">
				<div class="col-md-12" style="margin-top: 20px;display: inline-block;" >
					<div class="row">  
						<h5 style="display: inline-block;"><span class="required">* </span>采购周期： <input type="number"  class="form-control" id="purchasing_cycle_supplies_raw" name="purchasing_cycle_supplies_raw" style="width: 50%;display: inline-block;" value="<?php echo $product['purchasing_cycle']?>">天</h5> 
					</div>
					<div class="row">
			...
			<div class="col-md-10 bs-product-raw_material" style="margin-top: 60px" id="product_raw_material_div">
				<div class="col-md-6" style="margin-top: 20px" id="product_raw_material_div2">
					...
					<h5 style="display: block; margin-top: 10px;"></span>采购周期：<input type="text" class="form-control" id="purchasing_cycle_goods_raw" name="purchasing_cycle_goods_raw" style="display: inline;width: 30%;" value="<?php echo $product['purchasing_cycle']?>">天</h5>
			...
			<div class="col-md-10 bs-product-finish" style="margin-top: 60px" id="product_finish_div">
				<div class="col-md-10" style="margin-top: 20px" id="product_finish_div2">
					...
					<h5><span class="required">* </span>平台： <select id="platform_id" <?php if( $product['status'] != 'INIT' ) echo "disabled=\"disabled\""; ?> name="platform_id" class="form-control" style="width: 40%; display: inline-block;" ></select>
					</h5>
...
<div class="tab-pane fade" id="revenue_div">
	<div class="panel panel-default">
		<div class="panel-body">
			<?php if($this->helper->chechActionList(array('upsertFulFillRevenue'))) {?>
			<input id = "revenue_add_btn" type="button" class="btn btn-primary btn-sm" value="新增"><br><br>
			<?php }?>
			<table class="table table-striped table-bordered " style="width: 100%;border:3px;" id="fulfill_revenue_table">
				<div class="row">
					<label class="col-md-2">商品ID:  <span style="font-weight:normal"><?php echo isset($product['product_id']) ? $product['product_id'] : ''; ?></span></label>
					<label >商品名称:  <span style="font-weight:normal"><?php echo isset($product['product_name']) ? $product['product_name'] : '';?></span></label>
				</div>
	...
	<!-- 履约收入Modal -->
	<div>
		<div class="modal fade ui-draggable" id="revenue_modal" role="dialog"  >
			<div class="modal-dialog" style="width: 400px">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="revenue_title">履约收入档案</h4>
					</div>
					<div class="modal-body ">
						<div class="row">
							<label class="col-md-5" style="text-align:right">生效时间:</label>
							<input  id="start_time" style="width: 160px;" class=" form-control">
						</div>
						<div>
							<li class="divider">
						</div>
						<div class="row">
							<label class="col-md-6" style="text-align:right">仓储履约收入:</label>
							<input type='number' id="warehousing_revenue" style="width: 120px" class="revenues form-control">
						</div>
						<div class="row">
							<label class="col-md-6" style="text-align:right">干线收入:</label>
							<input type='number' id="trunk_revenue" style="width: 120px" class="revenues form-control">
						</div>
						<div class="row">
							<label class="col-md-6" style="text-align:right">配送收入:</label>
							<input type='number' id="shipping_revenue" style="width: 120px" class="revenues form-control">
						</div>
						<div class="row">
							<label class="col-md-6" style="text-align:right">耗材收入:</label>
							<input type='number' id="supplies_revenue" style="width: 120px" class="revenues form-control">
						</div>
						<div class="row">
							<label class="col-md-6" style="text-align:right">生产固定成本分摊:</label>
							<input type='number' id="production_cost_sharing" style="width: 120px" class="revenues form-control">
						</div>
						<div class="row">
							<label class="col-md-6" style="text-align:right">管理费用及其他分摊:</label>
							<input type='number' id="management_cost_sharing" style="width: 120px" class="revenues form-control">
						</div>
						<div class="row">
							<label class="col-md-6" style="text-align:right">其他收入:</label>
							<input type='number' placeholder="如没有则填0" id="other_revenue" style="width: 120px" class="revenues form-control">
						</div>
						<div class="row">
							<label class="col-md-6" style="text-align:right">备注:</label>
							<input id="other_note" style="width: 120px" class="form-control">
						</div>
						<div class="row">
							<label class="col-md-6" style="text-align:right">单个成品的总收入:</label>
							<input id="fulfill_revenue" style="width: 120px" class="form-control" readonly>
						</div>
					</div>
					<div class="modal-footer" >
						<input id="revenue_btn" type="button" class="btn btn-primary" style="text-align: right; <?php if(!$this->helper->chechActionList(array('setProductFacilityShiipping'))) echo 'display: none;';?>" value="保存"  >
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript" src="<?php if(isset($WEB_ROOT)) echo $WEB_ROOT;?>assets/js/js_wms/product_img.js"></script>
<script type="text/javascript" src="<?php if(isset($WEB_ROOT)) echo $WEB_ROOT;?>assets/js/js_wms/fulfill_revenue.js"></script>
